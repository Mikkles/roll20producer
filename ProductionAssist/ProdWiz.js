const Roll20Pro = (() => {
    ...
    //---------------Add to categories
        ...
        //==========AUTO LINKER===================
        autoLink2 = function (str, callerName) {
            let regex = /\[(?:([^\]|]*)|([^|]*)\|([^\]|]*))\]/g;
            let newStr = "";
            if (str == null) {
                str = ""
            ...
            return str.replace(regex, (all, oneWord, link, text) => {
                ...
                if (oneWord && oneWord.includes(":")) {
                    ...
                    case "5e":
                        return "<i><a href='https://roll20.net/compendium/dnd5e/Spells:" + spell[1] + "'>" + spell[1] + "</a></i>"
                        break;
                    }
                }
                ...
                if (link && text) {
                    if (link.includes(":")) {
                        ...
                        default:
                            ...
                            break; //This might be unnecessary?
                        case "5e":
                            return "<i><a href='https://roll20.net/compendium/dnd5e/Spells:" + spell[1] + "'>" + text + "</a></i>"
                            break;
                        }
                    ...
                    // return "<a href='http://journal.roll20.net/handout/" + targetID + "'>" + b + "</a>" 
                }
                ...
                // `<a href="myurl.com/${both ? both : target}">${both ? both : text}</a>`
        ...
        runAutoLinkTester = function (obj, field) {
            if (!eventChangeLockout) {
                ...
                obj.get(field, function (str) {
                    let newText = autoLink2(str, name);
